                                                ...
                                                <div
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" onkeyup="getDT(this)" list="dt"
                                                            class="form-control unset-border2" name="form2_dienthoai"
                                                ...
                                                <table class="table table-bordered"
                                                    ...
                                                    <thead>
                                                        <tr class="custom-tr">
                                                            ...
                                                            <th scope="col" class="border-custome" style="width: 40%">
                                                                Tên hàng hoá,dịch vụ
                                                                <br>
                                                                <span><i
                                                                        style="font-weight: normal !important">(Description)</i></span>
                                                            </th>
                                                            <th scope="col" class="border-custome" style="width: 8%">
                                                                ĐVT<br>
                                                                <span><i
                                                                        style="font-weight: normal !important">(Unit)</i></span>
                                                            </th>
                                                            <th scope="col" class="border-custome" style="width: 8%">Số
                                                                lượng<br>
                                                                <span><i
                                                                        style="font-weight: normal !important">(Quantity)</i></span>
                                                            </th>
                                                            <th scope="col" class="border-custome" style="width: 15%">
                                                                Đơn giá<br>
