                                    ...
                                    <div class="form-group d-flex custom-form-group-row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control unset-border" placeholder="...."
                                                autocomplete="off" name="form1_ngay" id="staticEmail"
                                                value="@if                                                (isset($arr)) {{ $arr[0] }} @endif">
                                        </div>
                                    </div>
                                    <div class="form-group d-flex custom-form-group-row2">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control unset-border" autocomplete="off"
                                                ...
                                                value="@if                                                (isset($arr)) {{ $arr[1] }} @endif">
                                        </div>
                                    </div>
                                    <div class="form-group d-flex custom-form-group-row2 col-sm-3">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control  unset-border" autocomplete="off"
                                                ...
                                                value="@if(isset($arr)) {{ $arr[2] }} @endif">
                                        </div>
                                    </div>
                                </div>
                                <label for="staticEmail" class="col-sm-2 col-form-label custom-label">
                            ...
                            <div class="form-group row custom-padding-top custom-padding-right custom-padding-left">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" autocomplete="off" class="form-control" list="dvbh" id="dvbh_id"
                                        onkeyup="getDVBH(this)" value="{{ $form2->don_vi_ban_hang }}" name="form2_dvbh">
                                    <datalist id="dvbh">
                                    </datalist>
                                </div>
                            </div>
                            ...
                            <div class="form-group row custom-padding-top custom-padding-right custom-padding-left">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" autocomplete="off" list="nh" onkeyup="getNH(this)"
                                        class="form-control" name="form2_nh" value="{{ $form2->ngan_hang }}" id="nh_id"
                            ...
                            <div class="form-group row custom-padding-top custom-padding-right custom-padding-left">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" autocomplete="off" list="cpn" onkeyup="getCPN(this)"
                                        class="form-control" id="cpn_id" value="{{ $form3->ten_don_vi }}" placeholder=""
                                        name="form3_dv">
                            ...
                            <div class="form-group row custom-padding-top custom-padding-right custom-padding-left">
                                ...
                                <div class="col-sm-9">
                                    <input type="quantity" autocomplete="off" list="tax" onkeyup="getTax(this)"
                                        class="form-control" id="tax_id" placeholder="" value="{{ $form3->ma_so_thue }}"
                                        name="form3_mst">
                            ...
                            <div class="form-group row custom-padding-top custom-padding-right custom-padding-left">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" list="ghichu" onkeyup="getNote(this)" autocomplete="off"
                                        class="form-control" id="ghichu_id" value="{{ $form3->ghi_chu }}" placeholder=""
                                        name="form3_note">
                            ...
                            <table class="table table-bordered" style="border: 1px solid black !important">
                                <thead>
                                    <tr class="custom-tr">
                                        ...
                                        <th scope="col" class="border-custome">Mã </th>
                                ...
                                <tbody id="body-table">
                                    ...
                                    <tr class="custom-tr count-tr">
                                        ...
                                        <td class="border-custome"><input type="text" autocomplete="off"
                                                ...
                                                name="form4_mahang[]" value=""><datalist
                                                id="mahang"></datalist></td>
                                        <td class="border-custome"> <input type="text" autocomplete="off"
                                        ...
                                        <td class="border-custome"><input type="text" autocomplete="off"
                                                ...
                                                onchange="updateTotal(this)" value="{{ $item->so_luong }}"><datalist
                                                id="soluong"></datalist>
                                        </td>
                                        <td class="border-custome"><input type="text" autocomplete="off"
                                                class="form-control" list="dongia" name="form4_dongia[]"
                                                onchange="updateTotal(this)" value="{{ $item->don_gia }}"><datalist
                                                id="dongia"></datalist>
                                        </td>
                                        <td class="border-custome"><input type="text" autocomplete="off" readonly=""
                                                class="form-control unset-border-input total" name="form4_thanhtien[]"
                                                value="{{ $item->thanh_tien }}"></td>
                                    ...
                                    <tr id="congtienhang">
                                        <th colspan="6" class="border-custome " scope="row">
                                    ...
                                    <tr>
                                        <th colspan="3" class="border-custome " scope="row">
                                    ...
                                    <tr>
                                        <th colspan="8" class="border-custome " scope="row">
