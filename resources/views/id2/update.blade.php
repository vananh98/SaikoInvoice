                                        ...
                                        <div class="form-group d-flex custom-form-group-row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control unset-border" placeholder="...."
                                                    autocomplete="off" name="form1_ngay" id="staticEmail" @if ($date) value="{{ $date }}"
                                                    @else
                                                                    value="" @endif>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex custom-form-group-row2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control unset-border" autocomplete="off"
                                                    name="form1_thang" id="inputPassword" placeholder="..." @if ($month) value="{{ $month }}"
                                                            @else
                                                                            value="" @endif>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex custom-form-group-row2 col-sm-3">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control  unset-border" autocomplete="off"
                                                    name="form1_nam" id="inputPassword" placeholder="..." @if ($year) value="{{ $year }}"
                                                            @else
                                                                            value="" @endif>
                                            </div>
                                        </div>
                                ...
                                <table class="table table-bordered" style="border: 1px solid black !important">
                                    <thead>
                                        <tr class="custom-tr">
                                            ...
                                            <th scope="col" class="border-custome">Mã hàng</th>
                                            <th scope="col" class="border-custome" style="width: 20%">Tên hàng hoá,dịch vụ
                                                <br>
                                            ...
                                            <th scope="col" class="border-custome" style="width: 8%">Thuế<br>
                                                <span><i style="font-weight: normal !important">(Tax %)</i></span>
                                            </th>
                                    ...
                                    <tbody id="body-table">
                                        ...
                                        @foreach ($form4->invoice_details as $item)
                                            <tr class="custom-tr count-tr">
                                                <th class="border-custome stt">{{ $i }}
                                                    <input type="text" value="{{ $item->id }}" name="form4_id_hang[]"
                                                        hidden>
                                                </th>

                                                <td class="border-custome"><input type="text" autocomplete="off"
                                                        class="form-control mahang_class" list="mahang"
                                                        onkeyup="getMahang(this)" name="form4_mahang[]"
                                                        value="{{ $item->ma_hang }}"><datalist id="mahang"></datalist>
                                                </td>
                                                <td class="border-custome"> <input type="text" autocomplete="off"
                                                ...
                                                <td class="border-custome" colspan="1"><input type="text" autocomplete="off"
                                                        class="form-control thue_class" onchange=" updateTotal(this)"
                                                        name="form4_thue[]" value="{{ $item->thue }}">
                                                    <datalist id="thue"></datalist>
                                                </td>
                                                ...
                                                <td class="border-custome"><button type="button" onclick="removeRow(this)"
                                                    ...
                                                    <input type="text" value="{{ $item->id }}" name="form4_id_item[]"
                                                        hidden>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        ...
                                        <tr>
                                            <th colspan="4" class="border-custome " scope="row">
                                        ...
                                        <tr>
                                            <th colspan="9" class="border-custome " scope="row">
